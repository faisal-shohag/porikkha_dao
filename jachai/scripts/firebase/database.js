!(function (t, e) {
  ...
  try {
    (function () {
      Ji =
        Ji && Object.prototype.hasOwnProperty.call(Ji, "default")
          ? Ji.default
          : Ji;
      var r = function (t, e) {
        return (r =
        ...
        Y =
          ...
          (K.prototype.debug = function () {
            ...
            this._userLogHandler &&
              this._userLogHandler.apply(this, V([this, q.DEBUG], t)),
              this._logHandler.apply(this, V([this, q.DEBUG], t));
          }),
          (K.prototype.log = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, V([this, q.VERBOSE], t)),
              this._logHandler.apply(this, V([this, q.VERBOSE], t));
          }),
          (K.prototype.info = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, V([this, q.INFO], t)),
              this._logHandler.apply(this, V([this, q.INFO], t));
          }),
          (K.prototype.warn = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, V([this, q.WARN], t)),
              this._logHandler.apply(this, V([this, q.WARN], t));
          }),
          (K.prototype.error = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, V([this, q.ERROR], t)),
              this._logHandler.apply(this, V([this, q.ERROR], t));
          }),
          K);
      function K(t) {
        (this.name = t),
      ...
      var X =
        (($.prototype.set = function (t, e) {
          null == e
            ...
            : this.domStorage_.setItem(this.prefixedName_(t), I(e));
        }),
      ...
      function nt(t, e) {
        C(
          ...
          !0 === t
            ? ((_t.logLevel = q.VERBOSE),
              (gt = _t.log.bind(_t)),
              e && ft.set("logging_enabled", !0))
            : "function" == typeof t
            ? (gt = t)
            : ((gt = null), ft.remove("logging_enabled"));
      }
      function rt() {
        ...
        if (
          (!0 === mt &&
            ((mt = !1),
            null === gt && !0 === ft.get("logging_enabled") && nt(!0)),
          gt)
        ) {
      ...
      var xt =
        ...
        (kt.prototype.checkValid_ = function () {
          if (this.byteLength_ > kt.MAX_PATH_LENGTH_BYTES)
            throw new Error(
              this.errorPrefix_ +
                "has a key path longer than " +
                kt.MAX_PATH_LENGTH_BYTES +
                " bytes (" +
                this.byteLength_ +
                ")."
            );
          ...
          (Wt.prototype.updateHost = function (t) {
            t !== this.internalHost &&
              ...
              this.isCacheableHost() &&
                dt.set("host:" + this.host, this.internalHost));
          }),
      ...
      function Qt(t) {
        ...
        return {
          repoInfo: new Mt(e.host, e.secure, n, r, "", n !== e.subdomain),
          path: new Dt(e.pathString),
        };
      }
      function qt(t) {
      ...
      function Vt(t) {
        return (
          null === t ||
          "string" == typeof t ||
          ("number" == typeof t && !ht(t)) ||
          (t && "object" == typeof t && R(t, ".sv"))
        );
      }
      ...
      function Xt(t, e, n) {
        ...
        if (
          ...
          (!qt(n.repoInfo.namespace) &&
            "localhost" !== n.repoInfo.host.split(":")[0]) ||
          (0 !== i.length &&
            ((r = (r = i) && r.replace(/^\/*\.info(\/|$)/, "/")), !Ut(r)))
        )
          throw new Error(
            A(t, e, !1) +
      ...
      var $t = function (t) {
        ...
        ee = function (n, t, e) {
          ...
          if ("string" == typeof t && t.length > te / 3 && W(t) > te)
            throw new Error(
              n +
        ...
        ne =
          ...
          (re.prototype.set = function (t, e) {
            F("OnDisconnect.set", 1, 2, arguments.length),
              ...
              Ht("OnDisconnect.set", 1, t, this.path_, !1),
          ...
          (re.prototype.update = function (t, e) {
            ...
            Bt("OnDisconnect.update", 1, t, this.path_, !1),
      ...
      var se,
        ...
        le =
          ...
          function (t) {
            ...
            var r = new Array(8);
            for (e = 7; 0 <= e; e--)
              (r[e] = se.charAt(t % 64)), (t = Math.floor(t / 64));
            ...
            if (n) {
              ...
              for (e = 0; e < 12; e++) he[e] = Math.floor(64 * Math.random());
      ...
      var we,
        ...
        Ie =
          ...
          (Ne.prototype.getImmediateChild = function (t) {
            return ".priority" === t
              ? this.priorityNode_
              : Ne.__childrenNodeConstructor.EMPTY_NODE;
          }),
          ...
          (Ne.prototype.updateImmediateChild = function (t, e) {
            return ".priority" === t
              ...
              ? this
              : Ne.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(
                  t,
                  e
            ...
            return null === n
              ...
              : (C(
                ...
                this.updateImmediateChild(
                  n,
                  Ne.__childrenNodeConstructor.EMPTY_NODE.updateChild(
                    t.popFront(),
                    e
                  )
                ));
          ...
          (Ne.prototype.hash = function () {
            if (null === this.lazyHash_) {
              ...
              this.priorityNode_.isEmpty() ||
                (t += "priority:" + Ce(this.priorityNode_.val()) + ":");
              var e = typeof this.value_;
              (t += e + ":"),
                (t += "number" == e ? Tt(this.value_) : this.value_),
                (this.lazyHash_ = et(t));
            }
          ...
          (Ne.prototype.compareTo = function (t) {
            return t === Ne.__childrenNodeConstructor.EMPTY_NODE
              ? 1
              : t instanceof Ne.__childrenNodeConstructor
              ? -1
      ...
      function ke(t, e, n, r, i) {
        (this.key = t),
          (this.value = e),
          (this.color = null != n ? n : ke.RED),
          (this.left = null != r ? r : Le.EMPTY_NODE),
          (this.right = null != i ? i : Le.EMPTY_NODE);
      }
      var Fe =
      ...
      function qe(t) {
        var e;
        (this.count = ((e = t + 1), parseInt(Math.log(e) / We, 10))),
      ...
      var Ue,
          ...
          var c = function (t, e) {
              ...
              if (1 == i)
                return (
                  (n = l[t]),
                  (r = u ? u(n) : n),
                  new xe(r, n.node, xe.BLACK, null, null)
                );
        ...
        je =
          (Object.defineProperty(Ye, "Default", {
            get: function () {
              return (
                C(Pe, "ChildrenNode.ts has not been loaded"),
                (Ue = Ue || new Ye({ ".priority": Be }, { ".priority": Pe }))
              );
            },
            enumerable: !0,
            configurable: !0,
              ...
              O(this.indexes_, function (t, e) {
                ...
                if ((C(n, "Missing index implementation for " + e), t === Be)) {
                  if (n.isDefinedOn(h.node)) {
                    for (
                      var r = [], i = l.getIterator(ue.Wrap), o = i.getNext();
                      o;
                ...
                var s = l.get(h.name),
                  a = t;
                return (
                  s && (a = a.remove(new ue(h.name, s))), a.insert(h, h.node)
                );
              }),
              this.indexSet_
            );
        ...
        Xe =
          ...
          ($e.prototype.hash = function () {
            if (null === this.lazyHash_) {
              var r = "";
              this.getPriority().isEmpty() ||
                (r += "priority:" + Ce(this.getPriority().val()) + ":"),
                this.forEachChild(Pe, function (t, e) {
                  var n = e.hash();
                  "" !== n && (r += ":" + t + ":" + n);
                }),
          ...
          ($e.prototype.getIteratorFrom = function (t, e) {
            ...
            for (
              var r = this.children_.getIteratorFrom(t.name, ue.Wrap),
                i = r.peek();
          ...
          ($e.prototype.getReverseIteratorFrom = function (t, e) {
            ...
            for (
              var r = this.children_.getReverseIteratorFrom(t.name, ue.Wrap),
                i = r.peek();
      ...
      Object.defineProperties(ue, {
        MIN: { value: new ue(Ct, Xe.EMPTY_NODE) },
        MAX: { value: new ue(Et, Ze) },
      }),
        (ye.__EMPTY_NODE = Xe.EMPTY_NODE),
        (Ie.__childrenNodeConstructor = Xe),
        (ge = Ze),
        (Se = Ze);
      var tn,
        en = !0;
        ...
        if (
          (St(r, function (t, e) {
            if ("." !== t.substring(0, 1)) {
              var n = nn(e);
              n.isEmpty() ||
                ((s = s || !n.getPriority().isEmpty()), o.push(new ue(t, n)));
            }
          }),
          0 === o.length)
        )
      ...
      var ln =
        ...
        (un.prototype.hasChild = function (t) {
          F("DataSnapshot.hasChild", 1, 1, arguments.length),
            zt("DataSnapshot.hasChild", 1, t, !1);
          var e = new Dt(t);
      ...
      var Cn =
        ...
        (En.validateQueryEndpoints_ = function (t) {
          ...
          if (
            ...
            (C(
              t.getIndex() instanceof an || t.getIndex() === sn,
              "unknown index type."
            ),
        ...
        (En.prototype.getRef = function () {
          return (
            ...
            new En.__referenceConstructor(this.repo, this.path)
          );
        }),
        ...
        (En.prototype.off = function (t, e, n) {
          ...
          var r = null,
            i = null;
          "value" === t
            ? (r = new _n(e || null, null, n || null))
            : t && (e && ((i = {})[t] = e), (r = new gn(i, null, n || null))),
        ...
        (En.prototype.orderByChild = function (t) {
          if ((F("Query.orderByChild", 1, 1, arguments.length), "$key" === t))
            throw new Error(
          ...
          return (
            En.validateQueryEndpoints_(r), new En(this.repo, this.path, r, !0)
          );
        }),
        (En.prototype.orderByKey = function () {
          ...
          return (
            En.validateQueryEndpoints_(t), new En(this.repo, this.path, t, !0)
          );
        }),
        ...
        (En.prototype.startAt = function (t, e) {
          void 0 === t && (t = null),
            ...
            Ht("Query.startAt", 1, t, this.path, !0),
            Kt("Query.startAt", 2, e, !0);
          var n = this.queryParams_.startAt(t, e);
          if (
            (En.validateLimit_(n),
            En.validateQueryEndpoints_(n),
          ...
          return (
            void 0 === t && (e = t = null),
            new En(this.repo, this.path, n, this.orderByCalled_)
          );
        }),
        (En.prototype.endAt = function (t, e) {
          void 0 === t && (t = null),
            F("Query.endAt", 0, 2, arguments.length),
            Ht("Query.endAt", 1, t, this.path, !0),
            Kt("Query.endAt", 2, e, !0);
        ...
        (En.prototype.equalTo = function (t, e) {
          if (
            ...
            Ht("Query.equalTo", 1, t, this.path, !1),
            Kt("Query.equalTo", 2, e, !0),
            this.queryParams_.hasStart())
          )
            throw new Error(
        ...
        (En.prototype.isEqual = function (t) {
          if ((F("Query.isEqual", 1, 1, arguments.length), !(t instanceof En)))
            throw new Error(
      ...
      var Rn = function (t, e, n) {
        ...
        Dn = function (t, e, n) {
          ...
          var i = e.node();
          if (
            (C(null != i, "Expected ChildrenNode.EMPTY_NODE for nulls"),
            !i.isLeafNode())
          )
            return r;
          var o = i.getValue();
      ...
      function On(t, r, i) {
        ...
        if (t.isLeafNode()) {
          var s = t,
            a = Rn(s.getValue(), r, i);
          return a !== s.getValue() || n !== s.getPriority().val()
            ? new Ie(a, nn(n))
            : t;
        }
        var h = t;
        return (
          n !== (o = h).getPriority().val() &&
            (o = o.updatePriority(new Ie(n))),
      ...
      ((kn = xn = xn || {})[(kn.OVERWRITE = 0)] = "OVERWRITE"),
        (kn[(kn.MERGE = 1)] = "MERGE"),
        (kn[(kn.ACK_USER_WRITE = 2)] = "ACK_USER_WRITE"),
        (kn[(kn.LISTEN_COMPLETE = 3)] = "LISTEN_COMPLETE");
      var Ln =
        ...
        Qn =
          ((qn.prototype.operationForChild = function (t) {
            ...
            return (
              ...
              new qn(this.path.popFront(), this.affectedTree, this.revert)
            );
          }),
          qn);
      function qn(t, e, n) {
      ...
      var Un =
        ...
        (Vn.prototype.findRootMostMatchingPathAndValue = function (t, e) {
          if (null != this.value && e(this.value))
            return { path: Dt.Empty, value: this.value };
          ...
          return null == i
            ? null
            : { path: new Dt(n).child(i.path), value: i.value };
        }),
      ...
      var Hn =
        ((Bn.prototype.operationForChild = function (t) {
          return this.path.isEmpty()
            ? new Bn(this.source, Dt.Empty)
            : new Bn(this.source, this.path.popFront());
        }),
        Bn);
      function Bn(t, e) {
      ...
      var jn =
        ((Yn.prototype.operationForChild = function (t) {
          return this.path.isEmpty()
            ? new Yn(this.source, Dt.Empty, this.snap.getImmediateChild(t))
            : new Yn(this.source, this.path.popFront(), this.snap);
        }),
        Yn);
      function Yn(t, e, n) {
        (this.source = t),
        ...
        ((zn.prototype.operationForChild = function (t) {
          if (this.path.isEmpty()) {
            ...
            return e.isEmpty()
              ? null
              : e.value
              ? new jn(this.source, Dt.Empty, e.value)
              : new zn(this.source, Dt.Empty, e);
          }
          return (
            C(
              this.path.getFront() === t,
            ...
            new zn(this.source, this.path.popFront(), this.children)
          );
        }),
            ...
            null != i &&
              (r.isLeafNode() ||
                r.forEachChild(Pe, function (t, e) {
                  n.hasChild(t) ||
                    i.trackChildChange(Zn.childRemovedChange(t, e));
                }),
              n.isLeafNode() ||
                n.forEachChild(Pe, function (t, e) {
                  if (r.hasChild(t)) {
                    ...
                    n.equals(e) ||
                      i.trackChildChange(Zn.childChangedChange(t, e, n));
        ...
        ((ir.prototype.trackChildChange = function (t) {
          ...
          if (r) {
            ...
            if (e === Zn.CHILD_ADDED && i === Zn.CHILD_REMOVED)
              this.changeMap.set(
                n,
                Zn.childChangedChange(n, t.snapshotNode, r.snapshotNode)
              );
            else if (e === Zn.CHILD_REMOVED && i === Zn.CHILD_ADDED)
              this.changeMap.delete(n);
            else if (e === Zn.CHILD_REMOVED && i === Zn.CHILD_CHANGED)
              this.changeMap.set(n, Zn.childRemovedChange(n, r.oldSnap));
            else if (e === Zn.CHILD_CHANGED && i === Zn.CHILD_ADDED)
              this.changeMap.set(n, Zn.childAddedChange(n, t.snapshotNode));
            else {
              if (e !== Zn.CHILD_CHANGED || i !== Zn.CHILD_CHANGED)
                throw c(
              ...
              this.changeMap.set(
                n,
                Zn.childChangedChange(n, t.snapshotNode, r.oldSnap)
              );
            }
        ...
        ur =
          ...
          (cr.maybeAddValueEvent_ = function (t, e, n) {
            ...
            if (r.isFullyInitialized()) {
              ...
              (0 < n.length ||
                ...
                n.push(Zn.valueChange(e.getCompleteEventSnap()));
            }
          }),
          (cr.prototype.generateEventCacheAfterServerEvent_ = function (
            t,
            e,
            n,
            r,
            ...
            if (e.isEmpty()) a = l.updateFullNode(h.getNode(), n, null);
              ...
              a =
                ".priority" === c
                  ...
                  : l.updateChild(h.getNode(), c, d, p, sr, null);
            }
          ...
          (cr.prototype.applyUserMerge_ = function (r, i, t, o, s, a) {
            ...
            return (
              t.foreach(function (t, e) {
                var n = i.child(t);
                cr.cacheHasChild_(r, n.getFront()) &&
          ...
          (cr.prototype.revertUserWrite_ = function (t, e, n, r, i) {
            ...
            return (
              (o =
                t.getServerCache().isFullyInitialized() ||
                null != n.shadowingWrite(Dt.Empty)),
        ...
        ((dr.prototype.generateEventsForChanges = function (t, e, n) {
          ...
          return (
            t.forEach(function (t) {
              t.type === Zn.CHILD_CHANGED &&
                r.index_.indexedValueChanged(t.oldSnap, t.snapshotNode) &&
                o.push(Zn.childMovedChange(t.childName, t.snapshotNode));
            }),
      ...
      function yr(t, e) {
        ...
        (this.viewCache_ = new $n(u, l)),
          (this.eventGenerator_ = new pr(this.query_));
      }
      var vr =
        ...
        (gr.prototype.removeEventRegistration = function (t, e, n) {
          ...
          return (
            h &&
              ...
              s.push(new gr.__referenceConstructor(t.repo, t.path)),
            { removed: s, events: a }
          );
        }),
      ...
      var mr =
        ...
        (Cr.prototype.removeWrite = function (t) {
          return t.isEmpty()
            ? Cr.Empty
            : new Cr(this.writeTree_.setTree(t, Un.Empty));
        }),
        ...
        (Cr.prototype.getCompleteNode = function (t) {
          ...
          return null != e
            ? this.writeTree_.get(e.path).getChild(Dt.relativePath(e.path, t))
            : null;
        }),
      ...
      var Er =
        ...
        (wr.prototype.calcEventCacheAfterServerOverwrite = function (
          t,
          e,
          n,
          r
        ...
        (wr.prototype.resetTree_ = function () {
          (this.visibleWrites_ = wr.layerTree_(
            this.allWrites_,
            wr.DefaultFilter_,
            Dt.Empty
          )),
        ...
        (wr.layerTree_ = function (t, e, n) {
          for (var r = mr.Empty, i = 0; i < t.length; ++i) {
            ...
            if (e(o)) {
              ...
              if (o.snap)
                n.contains(s)
                  ? ((a = Dt.relativePath(n, s)), (r = r.addWrite(a, o.snap)))
                  : s.contains(n) &&
                    ((a = Dt.relativePath(s, n)),
                    (r = r.addWrite(Dt.Empty, o.snap.getChild(a))));
              else {
                if (!o.children)
                  throw c("WriteRecord should have .snap or .children");
                if (n.contains(s))
                  (a = Dt.relativePath(n, s)), (r = r.addWrites(a, o.children));
                else if (s.contains(n))
                  if ((a = Dt.relativePath(s, n)).isEmpty())
                    r = r.addWrites(Dt.Empty, o.children);
                  else {
      ...
      var Tr =
        ((Ir.prototype.applyUserOverwrite = function (t, e, n, r) {
          return (
            ...
            r ? this.applyOperationToSyncPoints_(new jn(Ln.User, t, e)) : []
          );
        }),
        ...
        (Ir.prototype.addEventRegistration = function (t, e) {
          ...
          s
            ? ((o = o || s.hasCompleteView()),
              (i = i || s.getCompleteServerCache(Dt.Empty)))
            : ((s = new vr()),
        ...
        (Ir.parseQueryKey_ = function (t) {
          ...
          return (
            ...
            { queryId: t.substr(e + 1), path: new Dt(t.substr(0, e)) }
          );
        }),
        ...
        (Ir.prototype.applyOperationToSyncPoints_ = function (t) {
          return this.applyOperationHelper_(
            ...
            this.syncPointTree_,
            null,
            this.pendingWriteTree_.childWrites(Dt.Empty)
          );
        }),
      ...
      function Ir(t) {
        (this.listenProvider_ = t),
          (this.syncPointTree_ = Un.Empty),
          (this.pendingWriteTree_ = new Er()),
      ...
      var Or =
        ((xr.prototype.incrementCounter = function (t, e) {
          void 0 === e && (e = 1),
            R(this.counters_, t) || (this.counters_[t] = 0),
            (this.counters_[t] += e);
        }),
      ...
      var kr =
        ((Fr.getCollection = function (t) {
          var e = t.toString();
          return (
            this.collections_[e] || (this.collections_[e] = new Or()),
            this.collections_[e]
          );
        }),
          ...
          setTimeout(function () {
            try {
              ...
              (e.type = "text/javascript"),
                ...
                (e.onerror = function () {
                  rt("Long-poll script failed to load: " + t),
                    (r.sendNewPolls = !1),
                    r.close();
                }),
      ...
      "undefined" != typeof MozWebSocket
        ? (ii = MozWebSocket)
        : "undefined" != typeof WebSocket && (ii = WebSocket);
      var oi =
        ...
        (si.prototype.open = function (t, e) {
          ...
          (this.onDisconnect = e),
            ...
            (this.everConnected_ = !1),
            dt.set("previous_websocket_failure", !0);
          try {
            if (v()) {
              var r = h.NODE_ADMIN ? "AdminNode" : "Node",
                i = {
                  headers: {
                    "User-Agent":
                      "Firebase/5/" + ri + "/" + process.platform + "/" + r,
                  },
                },
                o = process.env,
                s =
              ...
              s && (i.proxy = { origin: s }),
                (this.mySock = new ii(this.connURL, [], i));
        ...
        (si.previouslyFailed = function () {
          return (
            dt.isInMemoryStorage || !0 === dt.get("previous_websocket_failure")
          );
        }),
      ...
      var ai =
        ...
        (hi.prototype.initTransports_ = function (t) {
          ...
          if (
            ...
            try {
              for (
                var s = f(hi.ALL_TRANSPORTS), a = s.next();
                !a.done;
                a = s.next()
              ) {
                var h = a.value;
        ...
        (ui.prototype.onHandshake_ = function (t) {
          ...
          (this.sessionId = t.s),
            ...
            0 === this.state_ &&
              ...
              "5" !== n && at("Protocol version mismatch detected"),
            ...
            t || 0 !== this.state_
              ...
              : (this.log_("Realtime connection failed."),
                this.repoInfo_.isCacheableHost() &&
                  (dt.remove("host:" + this.repoInfo_.host),
      ...
      var di,
          ...
          (_i.prototype.reduceReconnectDelayIfAdminCredential_ = function (t) {
            var e;
            ((t && 40 === t.length) ||
              ("object" == typeof (e = N(t).claims) && !0 === e.admin)) &&
              (this.log_(
          ...
          (_i.prototype.resume = function (t) {
            rt("Resuming connection for reason: " + t),
      ...
      function _i(t, e, n, r, i, o) {
        ...
        return (
          ...
          Yr.getInstance().on("visible", s.onVisible_, s),
          -1 === t.host.indexOf("fblocal") &&
            Gr.getInstance().on("online", s.onOnline_, s),
          s
        );
      }
      var yi,
      ...
      var mi = "repo_interrupt",
        Ci =
          ...
          (Ei.prototype.serverTime = function () {
            var t =
              this.infoData_.getNode(new Dt(".info/serverTimeOffset")).val() ||
              0;
          ...
          (Ei.prototype.update = function (o, t, s) {
            ...
            if (
              ...
              rt("update() called with empty data.  Don't do anything."),
          ...
          (Ei.prototype.interrupt = function () {
            this.persistentConnection_ &&
              this.persistentConnection_.interrupt(mi);
          }),
          ...
          (Ei.prototype.stats = function (t) {
            if ((void 0 === t && (t = !1), "undefined" != typeof console)) {
              ...
              e = t
                ? (this.statsListener_ ||
                    (this.statsListener_ = new Ar(this.stats_)),
      ...
      function Ei(t, e, n, r) {
        ...
        if (
          ...
          (this.persistentConnection_ = new fi(
            this.repoInfo_,
            this.onDataUpdate_.bind(this),
      ...
      var wi =
        ...
        (bi.prototype.updateChild = function (t, e, n, r, i, o) {
          return (
            this.matches(new ue(e, n)) || (n = Xe.EMPTY_NODE),
        ...
        (bi.prototype.updateFullNode = function (t, e, n) {
          ...
          return (
            e.forEachChild(Pe, function (t, e) {
              i.matches(new ue(t, e)) ||
                (r = r.updateImmediateChild(t, Xe.EMPTY_NODE));
            }),
        ...
        bi);
      function bi(t) {
        (this.indexedFilter_ = new er(t.getIndex())),
          (this.index_ = t.getIndex()),
          (this.startPost_ = bi.getStartPost_(t)),
          (this.endPost_ = bi.getEndPost_(t));
      }
      var Si =
            ...
            for (var c = !1; i.hasNext(); )
              (s = i.getNext()),
                ...
                c && o < this.limit_ && l(s, h) <= 0
                  ? o++
                  : (r = r.updateImmediateChild(s.name, Xe.EMPTY_NODE));
          }
        ...
        (Ti.prototype.fullLimitUpdateChild_ = function (t, e, n, r, i) {
          ...
          if (a.hasChild(e)) {
            ...
            if (u && !n.isEmpty() && 0 <= d)
              return (
                null != i && i.trackChildChange(Zn.childChangedChange(e, n, c)),
            ...
            return null != p && this.rangedFilter_.matches(p)
              ? (null != i &&
                  i.trackChildChange(Zn.childAddedChange(p.name, p.node)),
                f.updateImmediateChild(p.name, p.node))
              : f;
          }
          return !n.isEmpty() && u && 0 <= o(l, h)
            ? (null != i &&
                (i.trackChildChange(Zn.childRemovedChange(l.name, l.node)),
                i.trackChildChange(Zn.childAddedChange(e, n))),
              a
                .updateImmediateChild(e, n)
                .updateImmediateChild(l.name, Xe.EMPTY_NODE))
            : t;
        }),
        Ti);
      function Ti(t) {
        (this.rangedFilter_ = new wi(t)),
          (this.index_ = t.getIndex()),
      ...
      var Ii =
        ...
        (Ni.prototype.isViewFromLeft = function () {
          return "" === this.viewFrom_
            ? this.startSet_
            : this.viewFrom_ === Ni.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_LEFT;
        }),
        ...
        (Ni.prototype.getIndexStartName = function () {
          return (
            C(this.startSet_, "Only valid if start has been set"),
            this.startNameSet_ ? this.indexStartName_ : Ct
          );
        }),
        ...
        (Ni.prototype.getIndexEndName = function () {
          return (
            C(this.endSet_, "Only valid if end has been set"),
            this.endNameSet_ ? this.indexEndName_ : Et
          );
        }),
        ...
        (Ni.prototype.limitToFirst = function (t) {
          ...
          return (
            (e.limitSet_ = !0),
            (e.limit_ = t),
            (e.viewFrom_ = Ni.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_LEFT),
            e
          );
        }),
        (Ni.prototype.limitToLast = function (t) {
          ...
          return (
            (e.limitSet_ = !0),
            (e.limit_ = t),
            (e.viewFrom_ = Ni.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_RIGHT),
            e
          );
        }),
        ...
        (Ni.prototype.getNodeFilter = function () {
          return this.loadsAllData()
            ? new er(this.getIndex())
            : new (this.hasLimit() ? Si : wi)(this);
        }),
            ...
            this.isDefault() ||
              ((t =
                this.index_ === Pe
                  ...
                  : this.index_ === me
                  ? e.KEY_INDEX
                  : (C(this.index_ instanceof an, "Unrecognized index type!"),
                    this.index_.toString())),
              (n[e.ORDER_BY] = I(t)),
              this.startSet_ &&
                ((n[e.START_AT] = I(this.indexStartValue_)),
                this.startNameSet_ &&
                  (n[e.START_AT] += "," + I(this.indexStartName_))),
              this.endSet_ &&
                ((n[e.END_AT] = I(this.indexEndValue_)),
                this.endNameSet_ &&
                  (n[e.END_AT] += "," + I(this.indexEndName_))),
              this.limitSet_ &&
                (this.isViewFromLeft()
        ...
        Pi =
          ...
          (Di.prototype.set = function (t, e) {
            F("Reference.set", 1, 2, arguments.length),
              ...
              Ht("Reference.set", 1, t, this.path, !1),
          ...
          (Di.prototype.update = function (t, e) {
            ...
            Bt("Reference.update", 1, t, this.path, !1),
          ...
          (Di.prototype.transaction = function (t, r, e) {
            ...
            return (
              ...
              this.repo.startTransaction(
                ...
                t,
                function (t, e, n) {
                  t ? i.reject(t) : i.resolve(new ie(e, n)),
          ...
          (Di.prototype.push = function (t, e) {
            F("Reference.push", 0, 2, arguments.length),
              ...
              Ht("Reference.push", 1, t, this.path, !0),
      ...
      var Oi,
        ...
        Fi =
          ((Ai.prototype.subTree = function (t) {
            for (
              var e = t instanceof Dt ? t : new Dt(t),
                n = this,
                r = e.getFront();
              null !== r;

            )
              (n = new Ai(r, n, P(n.node_.children, r) || new ki())),
      ...
      ((xi = Oi = Oi || {})[(xi.RUN = 0)] = "RUN"),
        ...
        (Ci.prototype.startTransaction = function (t, e, n, r) {
          ...
          if (void 0 === h) {
            ...
            ee("transaction failed: Data returned ", h, s.path),
              (s.status = Oi.RUN);
            var u = this.transactionQueueTree_.subTree(t),
              c = u.getValue() || [];
            c.push(s), u.setValue(c);
            var p = void 0;
            if ("object" == typeof h && null !== h && R(h, ".priority"))
              (p = P(h, ".priority")),
                C(
                  Vt(p),
              ...
              p = (
                this.serverSyncTree_.calcCompleteEventCache(t) || Xe.EMPTY_NODE
              )
                .getPriority()
                .val();
            p = p;
        ...
        (Ci.prototype.getLatestState_ = function (t, e) {
          return (
            this.serverSyncTree_.calcCompleteEventCache(t, e) || Xe.EMPTY_NODE
          );
        }),
              ...
              if ("ok" === t) {
                ...
                if ("datastale" === t)
                  for (r = 0; r < h.length; r++)
                    h[r].status === Oi.SENT_NEEDS_ABORT
                      ? (h[r].status = Oi.NEEDS_ABORT)
                      : (h[r].status = Oi.RUN);
                else {
                  at("transaction at " + c.toString() + " failed: " + t);
                  for (r = 0; r < h.length; r++)
                    (h[r].status = Oi.NEEDS_ABORT), (h[r].abortReason = t);
                }
          ...
          if (0 !== t.length) {
            for (
              ...
              if (
                ...
                if (a.retryCount >= Ci.MAX_TRANSACTION_RETRIES_)
                  (l = !0),
                    (u = "maxretry"),
                    (i = i.concat(
                      this.serverSyncTree_.ackUserWrite(a.currentWriteId, !0)
                  ...
                  if (void 0 !== p) {
                    ...
                    var d = nn(p);
                    ("object" == typeof p && null != p && R(p, ".priority")) ||
        ...
        (Ci.prototype.pruneCompletedTransactionsBelowNode_ = function (t) {
          ...
          if (n) {
            for (var r = 0, i = 0; i < n.length; i++)
              n[i].status !== Oi.COMPLETED && ((n[r] = n[i]), r++);
          ...
          if (null !== e) {
            for (var n = [], r = [], i = -1, o = 0; o < e.length; o++)
              if (e[o].status !== Oi.SENT_NEEDS_ABORT)
                if (e[o].status === Oi.SENT)
                  C(
                    i === o - 1,
                    "All SENT items should be at beginning of queue."
                  ),
                    (e[(i = o)].status = Oi.SENT_NEEDS_ABORT),
                    (e[o].abortReason = "set");
                else if (
                  (C(
                    e[o].status === Oi.RUN,
      ...
      var Li,
        ...
        Wi =
          ...
          (Qi.prototype.deleteRepo = function (t) {
            ...
            (e && P(e, t.repoInfo_.toURLString()) === t) ||
              st(
                "Database " +
                  t.app.name +
                  "(" +
          ...
          (Qi.prototype.createRepo = function (t, e, n) {
            ...
            return (
              ...
              (i = new Ci(t, this.useRestClient_, e, n)),
              (r[t.toURLString()] = i)
            );
          }),
      ...
      var qi =
        ...
        (Ui.prototype.checkDeleted_ = function (t) {
          null === this.repo_ &&
            st("Cannot call " + t + " on a deleted database.");
        }),
        ...
        Ui);
      function Ui(t) {
        (this.repo_ = t) instanceof Ci ||
          st(
            "Don't call new Database() directly - please use firebase.database()."
          ),
          (this.root_ = new Pi(t, Dt.Empty)),
          (this.INTERNAL = new Vi(this));
      }
      var Vi =
      ...
      (Ki = (Yi = Ji).SDK_VERSION),
        ...
        Yi.registerVersion("@firebase/database", "0.6.2");
    }.apply(this, arguments));
  } catch (t) {
    throw (
      (console.error(t),
